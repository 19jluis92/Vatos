...
<div class="row">
	...
	<div class="piece form large-10 medium-9 columns">
		<form method="post" accept-charset="utf-8" action="index.php?controller=Piece&view=edit&id={$piece->id}">
			<fieldset>
				<legend>Edit Piece</legend>
				<div class="input text required"><label for="name">Name</label><input type="text" name="name" required="required" maxlength="45" id="name" value="{$piece->name}"></div>
			</fieldset>
