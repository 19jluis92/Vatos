...
<div class="row">
	...
	<div class="carType form large-10 medium-9 columns">
		<form method="post" accept-charset="utf-8" action="index.php?controller=CarType&view=edit&id={$carType->id}">
			<fieldset>
				<legend>Edit CarType</legend>
				<div class="input text required"><label for="name">Name</label><input type="text" name="name" required="required" maxlength="45" id="name" value="{$carType->name}"></div>
			</fieldset>
