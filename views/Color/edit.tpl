...
<div class="row">
	<div class="actions columns large-2 medium-3">
		...
		<ul class="side-nav">
			...
			<li><a href="index.php?controller=Color">List Color</a></li>
		</ul>
	</div>
	<div class="color form large-10 medium-9 columns">
		<form method="post" accept-charset="utf-8" action="index.php?controller=Color&view=edit&id={$color->id}">
			<fieldset>
				...
				<div class="input text required"><label for="name">Name</label><input type="text" name="name" required="required" maxlength="45" id="name" value="{$color->name}"></div>
			</fieldset>
