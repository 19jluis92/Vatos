...
<div class="row">
	<div class="actions columns large-2 medium-3">
		...
		<ul class="side-nav">
			...
			<li><a href="index.php?controller=Inspection">Inspecciones</a></li>
		</ul>
	</div>
	<div class="inspection form large-10 medium-9 columns">
		<form method="post" accept-charset="utf-8" action="index.php?controller=Inspection&view=edit&id={$inspection->id}">
			<fieldset>
				<legend>Agregar Inspeccion</legend>
				<div class="input number required">
					<label for="idservice">Id Servicio</label><input type="number" name="idService" required="required" id="idservice" value="{$inspection->idService}">
				</div>
				<div class="input number required">
					<label for="mileage">Millas</label>
					...
					<div class="input number required">
						...
						<div class="input datetime"><label for="inspectiondate">fecha de Inspeccion</label>
							<input type="date" name="inspectiondate" required="required" id="inspectiondate" value="{$inspection->inspectionDate}">
						</div>
						<div class="input textarea">
							<label for="type">Tipo</label><input type="checkbox" name="type" id="type" {if $inspection->type} checked="checked" {/if}></div>
						</fieldset>
