	...
	<div class="department form large-10 medium-9 columns">
		<form method="post" accept-charset="utf-8" action="index.php?controller=department&view=edit&id={$department->id}">
			<fieldset>
				...
				<div class="input text required"><label for="name">Name</label><input type="text" name="name" required="required" maxlength="45" id="name" value="{$department->name}"></div>
				<div class="input number required"><label for="idLocation">Id Location</label><input type="number" name="idLocation" required="required" id="idLocation" value="{$department->idLocation}"></div>
			</fieldset>
